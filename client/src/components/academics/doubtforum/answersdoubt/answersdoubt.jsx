...
import AnswerCarddoubt from './answer_carddoubt';
import QuestionCarddoubt from '../questionsdoubt/question_carddoubt';
import "./answersdoubt.css";
...
const Answersdoubt = () => {
    ...
    useEffect(() => {
        setAllAnswers([...Array((Data.answers.length) || 0)].map((_, index) => ({
            id: index + 1, card: <AnswerCarddoubt fetch={fetchData} id={Data.answers[index]._id} answer={Data.answers[index].answerDescription}
