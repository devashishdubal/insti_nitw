...
const QuestionCard = ({ fetch, id, user, date, title, description, tags, showAnswers, index, likes, dislikes }) => {
    ...
    return (
        <div className="individual_question">
            <span className="username"><i>u/{user}</i> - {date}</span>
            <div className="content">
                ...
                <div className="question_controls">
                    ...
                    <div className="likes">
                        ...
                        <button className="dislike_button" onClick={handleDislikeCick}>
