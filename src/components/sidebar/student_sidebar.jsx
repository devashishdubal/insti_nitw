...
const StudentSidebar = ({onButtonClick}) => {
    ...
    return (
        ...
        <div className="sidebar">
            <button onClick={()=> onButtonClick("Feed")}>
                ...
                {showSpans && <span className="button-desc">Feed</span> }
            </button>
            <button onClick={()=> onButtonClick("Calendar")}>
                ...
                {showSpans && <span className="button-desc">Calendar</span> }
            </button>
            <button onClick={()=> onButtonClick("Forum")}>
                ...
                {showSpans && <span className="button-desc">Forum</span> }
            </button>
            <button onClick={()=> onButtonClick("Academic")}>
                ...
                {showSpans && <span className="button-desc">Academics</span> }
            </button>
        </div>
