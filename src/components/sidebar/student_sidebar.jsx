...
const StudentSidebar = ({onButtonClick}) => {
    ...
    return (
        ...
        <div className="sidebar">
            <button className={`${!currRight ? 'expanded' : ''}`} onClick={()=> onButtonClick("Feed")}>
            ...
            <button className={`${!currRight ? 'expanded' : ''}`} onClick={()=> onButtonClick("Calendar")}>
            ...
            <button className={`${!currRight ? 'expanded' : ''}`} onClick={()=> onButtonClick("Forum")}>
            ...
            <button className={`${!currRight ? 'expanded' : ''}`} onClick={()=> onButtonClick("Academic")}>
